...
Turn repeated business processes into clear SOPs, checklists, roles, and quality controls.
...
```text
Use the skill in this folder: skills/operations/sop-builder/SKILL.md
...
This is an original workflow inspired by the broad problem space of **The E-Myth Revisited**. It is not a book summary or replacement.
