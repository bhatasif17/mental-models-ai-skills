...
Audit recurring work and identify what to eliminate, delegate, automate, or systemize.
...
```text
Use the skill in this folder: skills/operations/automation-opportunity-finder/SKILL.md
...
This is an original workflow inspired by the broad problem space of **The 4-Hour Workweek**. It is not a book summary or replacement.
