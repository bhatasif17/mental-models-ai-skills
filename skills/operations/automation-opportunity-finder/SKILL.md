...
description: Audit recurring work and identify what to eliminate, delegate, automate, or systemize.
version: 1.0.0
category: operations
inspired_by: "The 4-Hour Workweek"
---

# Automation Opportunity Finder

## Purpose
Automation Opportunity Finder helps users with this problem: Time leverage comes from removing low-value repetition.

This is an original AI workflow inspired by the general problem space of **The 4-Hour Workweek**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: audit recurring work and identify what to eliminate, delegate, automate, or systemize.
