...
Score and improve posts, reels, captions, and articles for practical value, emotional pull, and shareability.
...
```text
Use the skill in this folder: skills/content/shareability-scorer/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Contagious**. It is not a book summary or replacement.
