---
name: shareability-scorer
description: Score and improve posts, reels, captions, and articles for practical value, emotional pull, and shareability.
version: 1.0.0
category: content
inspired_by: "Contagious"
---

# Shareability Scorer

## Purpose
Shareability Scorer helps users with this problem: Content spreads when it gives people a reason to share.

This is an original AI workflow inspired by the general problem space of **Contagious**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: score and improve posts, reels, captions, and articles for practical value, emotional pull, and shareability.
