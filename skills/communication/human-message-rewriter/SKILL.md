---
name: human-message-rewriter
description: Rewrite difficult messages so they are clear, warm, respectful, and more likely to get a useful response.
version: 1.0.0
category: communication
inspired_by: "How to Win Friends and Influence People"
---

# Human Message Rewriter

## Purpose
Human Message Rewriter helps users with this problem: Communication fails when tone triggers defensiveness.

This is an original AI workflow inspired by the general problem space of **How to Win Friends and Influence People**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: rewrite difficult messages so they are clear, warm, respectful, and more likely to get a useful response.
