...
Rewrite difficult messages so they are clear, warm, respectful, and more likely to get a useful response.
...
```text
Use the skill in this folder: skills/communication/human-message-rewriter/SKILL.md
...
This is an original workflow inspired by the broad problem space of **How to Win Friends and Influence People**. It is not a book summary or replacement.
