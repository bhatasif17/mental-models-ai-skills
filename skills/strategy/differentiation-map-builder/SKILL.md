---
name: differentiation-map-builder
description: Find a stronger market angle by identifying what to remove, reduce, raise, and create.
version: 1.0.0
category: strategy
inspired_by: "Blue Ocean Strategy"
---

# Differentiation Map Builder

## Purpose
Differentiation Map Builder helps users with this problem: Differentiation comes from changing the value curve, not copying rivals.

This is an original AI workflow inspired by the general problem space of **Blue Ocean Strategy**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: find a stronger market angle by identifying what to remove, reduce, raise, and create.
