...
Find a stronger market angle by identifying what to remove, reduce, raise, and create.
...
```text
Use the skill in this folder: skills/strategy/differentiation-map-builder/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Blue Ocean Strategy**. It is not a book summary or replacement.
