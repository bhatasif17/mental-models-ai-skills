...
Clarify a product or service category, alternative, differentiation, tagline, and homepage positioning.
...
```text
Use the skill in this folder: skills/strategy/category-positioning-coach/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Positioning**. It is not a book summary or replacement.
