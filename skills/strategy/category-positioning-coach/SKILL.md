---
name: category-positioning-coach
description: Clarify a product or service category, alternative, differentiation, tagline, and homepage positioning.
version: 1.0.0
category: strategy
inspired_by: "Positioning"
---

# Category Positioning Coach

## Purpose
Category Positioning Coach helps users with this problem: Positioning should fit how customers already think.

This is an original AI workflow inspired by the general problem space of **Positioning**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: clarify a product or service category, alternative, differentiation, tagline, and homepage positioning.
