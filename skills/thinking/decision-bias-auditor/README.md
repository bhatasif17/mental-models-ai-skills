...
Audit important decisions for cognitive bias, emotional reasoning, missing evidence, and poor framing.
...
```text
Use the skill in this folder: skills/thinking/decision-bias-auditor/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Thinking, Fast and Slow**. It is not a book summary or replacement.
