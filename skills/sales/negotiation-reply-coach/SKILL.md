---
name: negotiation-reply-coach
description: Create calm, strategic, ethical replies for salary, client, vendor, and partnership negotiations.
version: 1.0.0
category: sales
inspired_by: "Never Split the Difference"
---

# Negotiation Reply Coach

## Purpose
Negotiation Reply Coach helps users with this problem: Negotiation improves when replies reduce emotion and reveal interests.

This is an original AI workflow inspired by the general problem space of **Never Split the Difference**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: create calm, strategic, ethical replies for salary, client, vendor, and partnership negotiations.
