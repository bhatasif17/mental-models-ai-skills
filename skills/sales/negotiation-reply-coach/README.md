...
Create calm, strategic, ethical replies for salary, client, vendor, and partnership negotiations.
...
```text
Use the skill in this folder: skills/sales/negotiation-reply-coach/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Never Split the Difference**. It is not a book summary or replacement.
