...
Generate sales discovery questions and call flows that uncover context, pain, consequences, and value.
...
```text
Use the skill in this folder: skills/sales/discovery-question-generator/SKILL.md
...
This is an original workflow inspired by the broad problem space of **SPIN Selling**. It is not a book summary or replacement.
