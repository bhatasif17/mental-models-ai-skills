...
description: Generate sales discovery questions and call flows that uncover context, pain, consequences, and value.
version: 1.0.0
category: sales
inspired_by: "SPIN Selling"
---

# Discovery Question Generator

## Purpose
Discovery Question Generator helps users with this problem: Better sales conversations come from better questions.

This is an original AI workflow inspired by the general problem space of **SPIN Selling**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: generate sales discovery questions and call flows that uncover context, pain, consequences, and value.
