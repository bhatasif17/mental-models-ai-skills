---
name: startup-advantage-analyzer
description: Evaluate whether a startup idea has a real strategic edge or is just another product.
version: 1.0.0
category: startup
inspired_by: "Zero to One"
---

# Startup Advantage Analyzer

## Purpose
Startup Advantage Analyzer helps users with this problem: Strong startups need sharp differentiation, not generic improvement.

This is an original AI workflow inspired by the general problem space of **Zero to One**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: evaluate whether a startup idea has a real strategic edge or is just another product.
