...
description: Choose the best initial niche by scoring urgency, ability to pay, access, and reference value.
version: 1.0.0
category: startup
inspired_by: "Crossing the Chasm"
---

# Beachhead Market Finder

## Purpose
Beachhead Market Finder helps users with this problem: Early markets need focus; selling to everyone weakens traction.

This is an original AI workflow inspired by the general problem space of **Crossing the Chasm**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: choose the best initial niche by scoring urgency, ability to pay, access, and reference value.
