...
Choose the best initial niche by scoring urgency, ability to pay, access, and reference value.
...
```text
Use the skill in this folder: skills/startup/beachhead-market-finder/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Crossing the Chasm**. It is not a book summary or replacement.
