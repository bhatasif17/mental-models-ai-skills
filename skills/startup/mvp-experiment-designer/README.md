...
Design lean validation experiments for startup ideas before users overbuild.
...
```text
Use the skill in this folder: skills/startup/mvp-experiment-designer/SKILL.md
...
This is an original workflow inspired by the broad problem space of **The Lean Startup**. It is not a book summary or replacement.
