...
description: Create neutral, evidence-based customer interview scripts that avoid false validation.
version: 1.0.0
category: startup
inspired_by: "The Mom Test"
---

# Customer Discovery Interviewer

## Purpose
Customer Discovery Interviewer helps users with this problem: Founders learn more from past behavior than polite opinions.

This is an original AI workflow inspired by the general problem space of **The Mom Test**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: create neutral, evidence-based customer interview scripts that avoid false validation.
