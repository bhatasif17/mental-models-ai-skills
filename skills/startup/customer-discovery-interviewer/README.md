...
Create neutral, evidence-based customer interview scripts that avoid false validation.
...
```text
Use the skill in this folder: skills/startup/customer-discovery-interviewer/SKILL.md
...
This is an original workflow inspired by the broad problem space of **The Mom Test**. It is not a book summary or replacement.
