...
description: Design ethical product retention loops around triggers, actions, rewards, investment, and re-engagement.
version: 1.0.0
category: product
inspired_by: "Hooked"
---
...
## Purpose
Retention Loop Designer helps users with this problem: Products need repeated value loops, not one-time curiosity.

This is an original AI workflow inspired by the general problem space of **Hooked**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: design ethical product retention loops around triggers, actions, rewards, investment, and re-engagement.
