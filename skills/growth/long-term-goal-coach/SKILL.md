---
name: long-term-goal-coach
description: Convert long-term ambitions into skill milestones, deliberate practice, tracking, and resilience plans.
version: 1.0.0
category: growth
inspired_by: "Grit"
---
...
## Purpose
Long-Term Goal Coach helps users with this problem: Long-term goals need purpose, practice, and recovery from setbacks.

This is an original AI workflow inspired by the general problem space of **Grit**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: convert long-term ambitions into skill milestones, deliberate practice, tracking, and resilience plans.
