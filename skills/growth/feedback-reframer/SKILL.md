...
description: Turn criticism, rejection, or performance feedback into useful learning signals and improvement actions.
version: 1.0.0
category: growth
inspired_by: "Mindset"
---
...
## Purpose
Feedback Reframer helps users with this problem: Feedback is more useful when treated as data instead of identity attack.

This is an original AI workflow inspired by the general problem space of **Mindset**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: turn criticism, rejection, or performance feedback into useful learning signals and improvement actions.
