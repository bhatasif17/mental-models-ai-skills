...
Turn criticism, rejection, or performance feedback into useful learning signals and improvement actions.
...
```text
Use the skill in this folder: skills/growth/feedback-reframer/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Mindset**. It is not a book summary or replacement.
