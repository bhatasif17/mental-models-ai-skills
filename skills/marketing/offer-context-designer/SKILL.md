---
name: offer-context-designer
description: Design the context, opening, and pre-frame that makes an offer easier to understand and accept.
version: 1.0.0
category: marketing
inspired_by: "Pre-Suasion"
---

# Offer Context Designer

## Purpose
Offer Context Designer helps users with this problem: The setup before an offer changes how the offer is perceived.

This is an original AI workflow inspired by the general problem space of **Pre-Suasion**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: design the context, opening, and pre-frame that makes an offer easier to understand and accept.
