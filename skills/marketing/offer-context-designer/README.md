...
Design the context, opening, and pre-frame that makes an offer easier to understand and accept.
...
```text
Use the skill in this folder: skills/marketing/offer-context-designer/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Pre-Suasion**. It is not a book summary or replacement.
