...
Turn vague ideas into simple, concrete, emotional, memorable messages.
...
```text
Use the skill in this folder: skills/marketing/message-stickiness-enhancer/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Made to Stick**. It is not a book summary or replacement.
