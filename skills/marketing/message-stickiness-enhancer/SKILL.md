---
name: message-stickiness-enhancer
description: Turn vague ideas into simple, concrete, emotional, memorable messages.
version: 1.0.0
category: marketing
inspired_by: "Made to Stick"
---

# Message Stickiness Enhancer

## Purpose
Message Stickiness Enhancer helps users with this problem: Messages spread when they are simple, concrete, credible, and emotionally useful.

This is an original AI workflow inspired by the general problem space of **Made to Stick**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: turn vague ideas into simple, concrete, emotional, memorable messages.
