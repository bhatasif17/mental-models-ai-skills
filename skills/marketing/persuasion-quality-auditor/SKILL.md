---
name: persuasion-quality-auditor
description: Improve landing pages, offers, posts, and sales messages using ethical persuasion and clear proof.
version: 1.0.0
category: marketing
inspired_by: "Influence"
---

# Persuasion Quality Auditor

## Purpose
Persuasion Quality Auditor helps users with this problem: Persuasion works best when it is clear, useful, and trustworthy.

This is an original AI workflow inspired by the general problem space of **Influence**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: improve landing pages, offers, posts, and sales messages using ethical persuasion and clear proof.
