...
Improve landing pages, offers, posts, and sales messages using ethical persuasion and clear proof.
...
```text
Use the skill in this folder: skills/marketing/persuasion-quality-auditor/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Influence**. It is not a book summary or replacement.
