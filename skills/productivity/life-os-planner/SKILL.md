...
description: Convert roles, responsibilities, values, and goals into a weekly personal operating system.
version: 1.0.0
category: productivity
inspired_by: "The 7 Habits of Highly Effective People"
---

# Life OS Planner

## Purpose
Life OS Planner helps users with this problem: People are busy but not aligned with what matters.

This is an original AI workflow inspired by the general problem space of **The 7 Habits of Highly Effective People**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: convert roles, responsibilities, values, and goals into a weekly personal operating system.
