---
name: focus-block-designer
description: Design realistic deep-work schedules around energy, distractions, deadlines, and shallow-work batching.
version: 1.0.0
category: productivity
inspired_by: "Deep Work"
---

# Focus Block Designer

## Purpose
Focus Block Designer helps users with this problem: High-value work needs protected focus blocks, not fragmented attention.

This is an original AI workflow inspired by the general problem space of **Deep Work**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: design realistic deep-work schedules around energy, distractions, deadlines, and shallow-work batching.
