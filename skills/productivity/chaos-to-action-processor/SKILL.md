---
name: chaos-to-action-processor
description: Turn brain dumps, messy notes, or emails into next actions, projects, waiting items, and scheduled work.
version: 1.0.0
category: productivity
inspired_by: "Getting Things Done"
---

# Chaos-to-Action Processor

## Purpose
Chaos-to-Action Processor helps users with this problem: Unclear inputs create stress; clear next actions create motion.

This is an original AI workflow inspired by the general problem space of **Getting Things Done**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: turn brain dumps, messy notes, or emails into next actions, projects, waiting items, and scheduled work.
