...
Turn brain dumps, messy notes, or emails into next actions, projects, waiting items, and scheduled work.
...
```text
Use the skill in this folder: skills/productivity/chaos-to-action-processor/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Getting Things Done**. It is not a book summary or replacement.
