...
Build tiny, repeatable habit systems from user goals, routines, friction points, and recovery needs.
...
```text
Use the skill in this folder: skills/productivity/habit-architect/SKILL.md
...
This is an original workflow inspired by the broad problem space of **Atomic Habits**. It is not a book summary or replacement.
