...
description: Build tiny, repeatable habit systems from user goals, routines, friction points, and recovery needs.
version: 1.0.0
category: productivity
inspired_by: "Atomic Habits"
---

# Habit Architect

## Purpose
Habit Architect helps users with this problem: People fail from poorly designed systems, not just weak motivation.

This is an original AI workflow inspired by the general problem space of **Atomic Habits**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: build tiny, repeatable habit systems from user goals, routines, friction points, and recovery needs.

## Required user inputs
Prefer to collect these inputs, but proceed with sensible assumptions if the user already gave enough context:
- goal
- current routine
- habit to build or remove
- available time
- main obstacle
