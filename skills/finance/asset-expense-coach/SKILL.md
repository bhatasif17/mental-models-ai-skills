---
name: asset-expense-coach
description: Classify purchases or investments as asset, liability, expense, or strategic investment and show cash-flow impact.
version: 1.0.0
category: finance
inspired_by: "Rich Dad Poor Dad"
---

# Asset vs Expense Coach

## Purpose
Asset vs Expense Coach helps users with this problem: Wealth improves when people understand cash-flow effects.

This is an original AI workflow inspired by the general problem space of **Rich Dad Poor Dad**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: classify purchases or investments as asset, liability, expense, or strategic investment and show cash-flow impact.
