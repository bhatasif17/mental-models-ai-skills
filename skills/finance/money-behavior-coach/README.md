...
Help users think clearly about financial choices by separating math, emotion, risk, and time horizon.
...
```text
Use the skill in this folder: skills/finance/money-behavior-coach/SKILL.md
...
This is an original workflow inspired by the broad problem space of **The Psychology of Money**. It is not a book summary or replacement.
