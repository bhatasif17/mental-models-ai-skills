---
name: money-behavior-coach
description: Help users think clearly about financial choices by separating math, emotion, risk, and time horizon.
version: 1.0.0
category: finance
inspired_by: "The Psychology of Money"
---

# Money Behavior Coach

## Purpose
Money Behavior Coach helps users with this problem: Money decisions are behavioral, not just mathematical.

This is an original AI workflow inspired by the general problem space of **The Psychology of Money**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: help users think clearly about financial choices by separating math, emotion, risk, and time horizon.
