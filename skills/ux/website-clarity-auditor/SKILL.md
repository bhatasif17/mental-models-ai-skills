---
name: website-clarity-auditor
description: Audit a website or landing page for first-impression clarity, navigation, trust, CTA, and conversion friction.
version: 1.0.0
category: ux
inspired_by: "Don’t Make Me Think"
---

# Website Clarity Auditor

## Purpose
Website Clarity Auditor helps users with this problem: Users should quickly understand what the page offers and what to do next.

This is an original AI workflow inspired by the general problem space of **Don’t Make Me Think**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: audit a website or landing page for first-impression clarity, navigation, trust, CTA, and conversion friction.
