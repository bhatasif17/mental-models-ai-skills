---
name: usability-problem-finder
description: Review product screens, flows, or descriptions for affordance, feedback, errors, and mental-model mismatches.
version: 1.0.0
category: ux
inspired_by: "The Design of Everyday Things"
---

# Usability Problem Finder

## Purpose
Usability Problem Finder helps users with this problem: Confusing design usually fails to signal what users should do.

This is an original AI workflow inspired by the general problem space of **The Design of Everyday Things**. It is not a summary, replacement, derivative copy, or reproduction of the book.

## When to use this skill
Use this skill when the user wants to: review product screens, flows, or descriptions for affordance, feedback, errors, and mental-model mismatches.
